...
/*************************************************
* Name:        MLDSA_NAMESPACE(montgomery_reduce)
*
...
int32_t MLDSA_NAMESPACE(freeze)(int32_t a) {
    a = MLDSA_NAMESPACE(reduce32)(a);
    a = MLDSA_NAMESPACE(caddq)(a);
    return a;
}
